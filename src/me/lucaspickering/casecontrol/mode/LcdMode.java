...
public interface LcdMode extends Serializable {
   ...
   *
   * @return a String[] of length {@link me.lucaspickering.casecontrol.Data#LCD_HEIGHT}, with each String no longer
   * than {@link me.lucaspickering.casecontrol.Data#LCD_WIDTH} characters long.
   */
  String[] getText();
