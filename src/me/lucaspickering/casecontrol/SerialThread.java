...
//          System.err.printf("Error! Expected ACK of %d but received %d!\n", bytesExpected, ack);
	 ...
	 * SerialPort#writeString} work by forcing the default encoding to windows-1232, but I'm not sure
	 * how portable that is (will Linux like that?) and as far as I can tell, the only way to do that
	 * is with a VM flag (-Dfile.encoding=windows-1232) when the program starts, and having to
	 * remember to set up a VM flag is dumb. If you're future me and you're reading this, you're
